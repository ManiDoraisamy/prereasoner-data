...
class Proposer:
    ...
    def propose(self, tables, question, graph, min_score=0.0):
        """Return validated typed-AST candidates for the question (possibly empty)."""
        import torch
        ...
        try:
            ...
            return []
        return [ScoredQuery(query, rendered, min_score - _PROPOSER_PENALTY,
                            ("proposer:greedy",))]
