...
('city') to their taxonomy node qid (Q515) via knowledgebase."types".resolver_type, then VERIFY
...
onto every word row means rewriting the whole table — and knowledgebase."words" has an HNSW
