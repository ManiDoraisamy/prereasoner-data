...
SUITES = ["tests.test_sql_ast", "tests.test_calculations", "tests.test_analysis", "tests.test_deterministic_emitters", "tests.test_routing", "tests.test_router_evidence", "tests.test_schema_decode",
