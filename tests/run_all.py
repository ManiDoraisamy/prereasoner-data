...
SUITES = ["tests.test_sql_ast", "tests.test_emitter_parity", "tests.test_calculations", "tests.test_analysis", "tests.test_routing", "tests.test_router_evidence", "tests.test_schema_decode",
