...
Review [`deploy/gcp/deploy.sh`](https://github.com/ManiDoraisamy/prereasoner-data/blob/v0.2.2/deploy/gcp/deploy.sh),
...
[`web/README.md`](https://github.com/ManiDoraisamy/prereasoner-data/blob/v0.2.2/web/README.md) and attach
