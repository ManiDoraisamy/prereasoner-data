...
(async () => {
  ...
  const fixtureContext = JSON.stringify({spreadsheet:'Prereasoner- Sheets Copilot',activeSheet:'Customers',totalRows:23,tables:[{name:'Customers'}],privacyUrl:'https://chat.prereasoner.com/privacy'});
